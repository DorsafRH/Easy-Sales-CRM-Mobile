...
export const makeStyles = (theme: AppTheme) =>
  StyleSheet.create({
    ...
    statLabel: { fontSize: 11, fontWeight: '500', color: theme.colors.textSecondary },
    ...
    finDesc:  { fontSize: 10, color: theme.colors.textTertiary },

    // ── Répartition pipeline — donut chart ────────────────────
    pieCard: {
      backgroundColor: theme.colors.bgSurface,
      borderRadius:    theme.radius.lg,
      borderWidth:     1,
